...
class Runner(object):
    def __init__(self, cfg):
        ...
        self.writer = SummaryWriter(log_dir=self.cfg.work_dir)
    ...
    def train_epoch(self, epoch, train_loader):
        ...
        for i, data in enumerate(train_loader):
            ...
            for key, value in output['loss_stats'].items():
                try:
                    value = value.item()
                except:
                    pass
                if key != 'loss_stats':
                    self.writer.add_scalar("Train/" + str(key), value, epoch*max_iter+i)
        ...
        self.writer.add_scalar("Train/Epoch_loss", total_loss/max_iter, epoch)
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.cfg.epochs):
            ...
            if (epoch +
                ...
                self.writer.add_scalar("Val/Epoch_accuracy", metric, epoch)
            if self.recorder.step >= self.cfg.total_iter:
                break
